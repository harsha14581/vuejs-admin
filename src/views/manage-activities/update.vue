...
export default {
  ...
  methods: {
    ...
    getActivity(){
        this.axios.get(apiEndPoints.apis.get_activities,{ params: {
    ...
    updateActivity(){
      ...
      form_data.append("activity_id", this.$route.params.activityId);
      ...
      this.axios.post(apiEndPoints.apis.update_activity,form_data)
          .then(response => {
